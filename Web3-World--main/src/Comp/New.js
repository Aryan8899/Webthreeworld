...
function New() {
  ...
  const renderSlide = (slide) => {
    if (slide.title === "Trending") {
        ...
        <div className="p-4 border border-gray-300 rounded-lg shadow-lg bg-white h-full flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <h4 className="font-bold text-sm mb-2 ">Top Gainers</h4>
                <ul>
              ...
              <div>
                <h4 className="font-bold text-sm">Top Losers</h4>
                <ul>
      ...
      return (
        <div className="p-4 border border-gray-300 rounded-lg shadow-lg bg-white h-50 flex flex-col justify-center mx-auto">
          <div className="text-center">
            <h3 className="font-bold text-md -mt-3">Advertisement</h3>
            <a
            ...
            >
              <img className="cursor-pointer -mb-2" src={trade} alt="Advertisement" />
            </a>
          </div>
        </div>
      );
      ...
      return (
        <div className="p-4 border border-gray-300 rounded-lg shadow-lg bg-white h-45 flex flex-col justify-center mx-auto">
          <div className="text-center">
            <h3 className="font-bold text-md -mt-3">Advertisement</h3>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img className="cursor-pointer -mb-2" src={kuku} alt="Advertisement" />
            </a>
          </div>
        </div>
      );
      ...
      return (
        <div className="p-4 border border-gray-300 rounded-lg shadow-lg bg-white h-full flex flex-col justify-center mx-auto">
          <div className="text-center">
            <h3 className="font-bold text-md -mt-3">Advertisement</h3>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img className="cursor-pointer -mb-2" src={bybit} alt="Advertisement" />
            </a>
          </div>
        </div>
      );
